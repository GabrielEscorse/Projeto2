...
Route::group(['prefix' => 'produto'], function(){
    ...
    Route::post('/update', [ProdutoController::class, 'salvar_alterar']);
});
...
Route::group(['prefix' => 'marca'], function(){
    ...
    Route::post('/update', [MarcaController::class, 'salvar_alterar']);
...
Route::group(['prefix' => 'categoria'], function(){
    ...
    Route::post('/update', [CategoriaController::class, 'salvar_alterar']);
});
...
Route::group(['prefix' => 'cor'], function(){
    ...
    Route::post('/update', [CorController::class, 'salvar_alterar']);
});
